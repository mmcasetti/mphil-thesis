...
{\Large Complexity of the Gale String Problem for Equilibrium Computation
in Games}
...
Thesis submitted to the Department of Mathematics of the London
School of Economics and Political Science for the degree of Master of
Philosophy
...
von Stengel, published in \cite{main}. The appendix was the
result of previous study for the Master of Science degree I undertook at
the London School of Economics and Political Science in 2008, see
\cite{msc-diss}.
...
\chapter{Complexity, Games, Labels and Gale Strings}

\input{chapter-1/complexity-classes}

\input{chapter-1/games}

\input{chapter-1/labels}

\input{chapter-1/gale-def}

\chapter{Algorithmic and Complexity Results}\label{main-chapter}

\input{chapter-2/lemke-howson}

\input{chapter-2/main-result}

\chapter{Further results}

\chapter*{A Note on the PPAD Completeness of {\sc Nash}}
\addcontentsline{toc}{chapter}{Appendix: A Note on the PPAD Completeness of {\sc Nash}}

\todo[inline]{appendix/ppad-msc}

\chapter*{Polytopes}
\addcontentsline{toc}{chapter}{Polytopes}

\todo[inline]{change the title}

\input{appendix/polytopes}
