...
We begin by giving some background definitions and notation that will be
used throughout this thesis. The first section will cover polytopes
...
\input{appendix/further-results}
