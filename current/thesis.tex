...
\subsection{The Problem \gale}\label{gale-pbl-sect}
...
a a complete or almost complete labelling of~$l$; $i \in [n]$ such that
$s(i)=1$}
\Output{A different Gale string $s'$ that describes a complete or almost
complete labelling of~$l$.}
...
run of $1$s either on the right or on the left of position $i$. The
