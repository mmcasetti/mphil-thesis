...
\todo[inline]{begin thm, begin proof, end proof, end thm. (environment pf
inside environment thm)}
...
\begin{example}
We consider the labeling $l=123142$; the corresponding graph $G$ is the
following, with only two possible perfect matchings, $M=\{e_2,e_5\}$ and
$M'=\{e_4,e_6\}$.
