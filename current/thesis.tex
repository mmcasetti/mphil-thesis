...
\todo[inline]{pivoting for *almost* completely labeled GS, with example!
(replacing the GS to GS example).}
...
The operation where we set $s'(i)=0$ (in line 2) is called {\em dropping
label $i$}.
...
\cline{2-2}
\textbf{123}43\textbf{2} &
there is a \textbf{1} in $s$ in a position corresponding to the labels
\textbf{1}, \textbf{2} {\bf (twice)} and \textbf{3} in $l$; there are only
\textbf{0}'s in all the positions corresponding to the label \textbf{4} in $l$ \\
\hline
\end{tabular}
}\\
\end{center}
...
drop the label \textbf{2} from $l$ \\
\textbf{1\underline{1}11}00 &
taking the corresponding \textbf{1} in $s$ \\
\textbf{1\underline{0}11}00 &
and setting it to \textbf{0} \\
\cline{2-2}
\textbf{1}0\textbf{11}0\textbf{1} &
...
{\bf all the labels} in $l$ correspond to a \textbf{1} in $s$ \\
\hline
\end{tabular}
}\\
\end{center}
