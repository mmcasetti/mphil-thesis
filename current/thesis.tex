...
\fxnote{game-theoretic part - TODO}
...
\fxnote{game theory and polytopes - TODO, again}
...
% graphic of Cyclic polytope - w/labels (maybe one w/out after def of CP)
...
\fxnote{The framework provided by our result led to further questions, related to the issue of the *sign* of an index - and so on (Merschen, VvS) - graph of lhg zig-zag. Open problems (?)}
