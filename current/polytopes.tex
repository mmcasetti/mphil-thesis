...
Savani and von Stengel \cite{uvg} extended proposition
\ref{imitation-thm} to {\em unit vector games}, that is, games
of the form $(U,B)$, where the columns of the matrix $U$ are unit vectors.
Their study relies on a theorem, first proved in dual form by
Balthasar \cite{balthasar}, that exploits the techinque of labeling.
...
\todo[inline]{$P$ is simple (why? show it before), so $P^\Delta$ is simplicial}
...
\todo[inline]{
$F_0$ correspond to ``artificial'' equilibrium, as $(\0)$ before.
