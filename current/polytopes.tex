...
\todo[inline]{so results in next section don't get lost in boredom, and
each section in background is about 150-200 lines (see: getting lost).

Maybe turn this into an appendix?}
...
also called {\em bimatrix games}. Their Nash equilibria can be analysed
from a geometrical point of view using {\em labels}.
