...
and von Stengel \cite{uvg}, dual to the one in Balthasar \cite{balthasar}.
...
The dual version of theorem \ref{unit-vector-thm} is based on the following
construction (see \cite{balthasar}).
...
we can have \1 is in the interior of $P^l$; then we have that \0 is in
the interior of $P$.
...
Since \0 is in the interior of $P$, the facets of $P^\Delta$ correspond to
the vertices of $P$ and vice versa; we can then label the vertices
of $P\Delta$ with the labels of the corresponding facets in $P^l$, and we
will have completely labeled facets of $P\Delta$ corresponding to
completely labeled vertices $P^l$.
In particular, the facet corresponding to \0 is
\begin{equation}
F_0 = \{ x\in P^\Delta\ |\ -\1\T x = 1 \} = \conv\{ e_i\ |\ i\in [m] \}.
\end{equation}

We therefore have the dual of theorem \ref{unit-vector-thm}, as enunciated
in \cite{balthasar}.
...
\todo[inline]{
see as comp problems: ANOTHER CL FACET / ANOTHER CL VERTEX
sp case of 2-NASH
