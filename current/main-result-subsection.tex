...
Our proof will be based on a simple graph construction, based on the idea of
{\em perfect matching} and a theorem by Edmonds (\cite{edm}).

A perfect matching for a graph $G=(V,E)$ is a set $M\subseteq E$ of
...
The problem {\sc Perfect Matching}, defined as
