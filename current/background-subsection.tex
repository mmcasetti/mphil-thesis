...
The class $\mathrm{\mathbf{FP}}$ of all the function problems that can
be solved in polynomial time is analogously defined.

The class $\mathrm{\mathbf{NP}}$,
{\em non-deterministic polynomial-time problems}, is the class of problems
$P$ such that there exists a Turing machine $\mathcal{M}$ and polynomials
$p_1,p_2$ such that
...
The class $\mathrm{\mathbf{FNP}}$ is defined as the class of binary
