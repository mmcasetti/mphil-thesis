...
build Gale games that are ``hard to solve''
The Gale game immediately associated with the labeling gives an example of 
exponential running time for the Lemke-Howson algorithm, but it is still
quite tractable by support enumeration; a more complex construction
given in \cite{svs} and later simplified in \cite{uvg}
