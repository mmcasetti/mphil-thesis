...
Given a bimatrix game $(A,B)$, it takes polynomial time to write and solve
the linear equations defining its best response polyhedra $\bar{P},\bar{Q}$
and its best response polytopes $P,Q$. It also take polynomial time to
label both $\bar{P},\bar{Q}$ and $P,Q$. Therefore we have a polynomial time
reduction from the problem 2-{\sc Nash} to the problems
{\sc Another Completely Labeled Facet} and
{\sc Another Completely Labeled Vertex}, defined as follows.
...
\begin{proposition}
\label{2nash-to-acl}
The problem 2-{\sc Nash} reduces in polynomial time to
{\sc Another Completely Labeled Facet} and
