...
\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/cyc36.pdf}
\hfill\strut
...
\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/cyc36fac.pdf}%
\hfill\strut
\caption{%
...
\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/c46.pdf}%
\hfill\strut
\caption{%
...
On the hyperplane, the string $s=111100$ can be seen as in figure
...
Left: The cyclic polytope $C_4(6)$; the vertices are labeled with the
indices $i\in [6]$.
Right: The cyclic polytope $C_4(6)$; the vertices are labeled following
