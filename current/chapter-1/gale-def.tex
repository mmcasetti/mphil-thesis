...
\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/c36.pdf}%
\hfill\strut
...
We have that
$C_d(n) =
\conv\{ \mu_d(\bar{t_j})\text{ for some } \bar{t_1} < \ldots < \bar{t_n} \}$.
...
$t_i$'s with $i\in [d]$ such that for all the $\bar{t_k}$'s with $k\in [n]$ and
...
in figure \ref{c36fac-fig}.

\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/c36fac.pdf}%
\hfill\strut
\caption{%
...
Gale string $s\in G(3,6)$ is $s=100110$.

On the hyperplane, the correspondence is as in figure \ref{c36fac-hyper-fig}.

\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/100110-hyper.pdf}%
\hfill\strut
\caption[A facet of $C_3(6)$ as a Gale string in $G(3,6)$]{%
A facet of the cyclic polytope $C_3(6)$ and the corresponding Gale string
$s\in G(3,6)$.
}
\label{c36fac-hyper-fig}
\end{figure}
\end{example}
...
to the Gale string $s=111100$.

\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/c46fac.pdf}%
\hfill\strut
\caption{%
...
On the hyperplane, the string $s$ can be seen as in figure
\ref{c46fac-hyper-fig}.

\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/111100-hyper.pdf}%
\hfill\strut
\caption{%
The Gale string $s=111100$.
}
\label{c36fac-fig}
\end{figure}
\end{example}
...
corresponding bitstring would be $s=111010$, not a Gale string. The point
in pink and the point in green are on different sides of the hyperplane $H$,
so they do not belong to the same facet.

\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/notfacet-even-hyper.pdf}%
\hfill\strut
...
Analogously for the string $s=10101$, corresponding to figure
\ref{notfacet-odd-hyper-fig}

\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=27ex]{chapter-1/fig/notfacet-odd-hyper.pdf}%
\hfill\strut
