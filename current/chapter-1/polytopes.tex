...
affinely independent points. A convex set of dimension $d$ is called a
{\em $d$-simplex}. The {\em standard $d$-simplex} is
$\Delta_d=\conv\{ e_1,\ldots,e_{d+1} \}$.

A {\em polytope} is the convex hull of a finite set of points
$\{z_1,\ldots,z_m \}\subset\reals^n$, not necessarily affinely
independent; the {\em dimension} of the polytope is the dimension
of its convex hull.
A {polyhedron} is the intersection of finitely many closed halfspaces
$\{ x\in \reals^d\mid a^T x\leq a_0\}$; note that a bounded polyhedron is
a polytope.
...
vertices $u$ of $P$; the vector $a$ (taken as unique up to a scalar
multiple) is called the {\em normal vector} of the facet.
...
if every point of $P$ lies on at most than $d$ facets; note that the points
lying on exactly $d$ facets are exactly the vertices.

The {\em polar} of the polytope
$P=\{ x\in\reals^d\ \mid\ x\T c_i\leq 1,\ i\in [k] \}$ with $c_i\in\reals^d$
is $P^\Delta = \conv\{ c_i, i\in [k] \}$.
If $P$ is simplicial or
it is simple and it contains the origin $\0$, then $P^{\Delta\Delta}=P$;
furthermore, if $P$ is simplicial $P^\Delta$ is simple, and vice versa.
