...
$\{ x\in \reals^d\ \mid\ a\T x\leq a_0\}$. It can be shown that a bounded polyhedron
is a polytope.
...
as endpoints.
A {\em facet} of $P$ is a set of dimension $d-1$ that is the convex hull of a set of vertices
