...
input), or the {\em rejecting state} with output {\sc No} (the
Turing machine {\em rejects} the input).

% mention decision vs function here: function has additional output tape,
% then it's clearer later with all the M(x)
...
% rewrite the last pararaph,
%% especially the sentence about when a TM accepts a language
