...
of opposite sign'' to the problem {\sc Opposite Sign Gale} of
...
A first polynomial-time algorithm for {\sc Opposite Sign Gale} of
...
\begin{figure}[hp]
\strut\hfill
\includegraphics[height=50ex]{chapter-4/fig/octa-poly-facets-v2.pdf}%
\hfill\strut
...
\begin{figure}[hp]
\strut\hfill
\includegraphics[width=55ex]{chapter-4/fig/octa-poly-paths-v2.pdf}%
\hfill\strut
\caption[Endpoints of the Dual Lemke-Howson Algorithm \ref{dlh-alg}]
{The endpoints of the Lemke paths on the octahedron in
...
room partitions, Figure \ref{octa-rp-fig}. The exchange algorithm
of Edmonds \cite{edm-oiks} from room partition $B$ to room partition $A$
dropping vertex $v=1$
is shown in Figure \ref{exchange-rp-fig}. The graph describing its endpoints,
analogous to Figure \ref{octa-poly-paths-fig} is shown in
Figure \ref{octa-rp-paths-fig} and it is not bipartite.
Giving a sign to the room partitions cannot be done simply through
Edmonds' exchange algorithm.

\begin{figure}[hp]
\strut\hfill
\includegraphics[height=50ex]{chapter-4/fig/octa-rp.pdf}%
\hfill\strut
...
\strut\hfill
\strut\hfill
\includegraphics[width=55ex]{chapter-4/fig/octa-rp-paths.pdf}%
\hfill\strut
\caption[Endpoints of the Exchange Algorithm]
{Endpoints of the Exchange Algorithm on the octahedron in
Figure \ref{octa-rp-fig}.}
...
\strut\hfill
\begin{center}
\includegraphics[height=43ex]{chapter-4/fig/octa-exchange-1.pdf}%
\vspace{10ex}
\includegraphics[height=43ex]{chapter-4/fig/octa-exchange-2.pdf}%
\end{center}
\hfill\strut
\caption[The Exchange Algorithm]
{Top: Drop vertex $1$ from room partition $B$. Pivot from room $B_1$ to
room $A_1$. The new vertex $4$ is duplicate in room $A_1$ and room $B_2$.\\
Bottom: Drop duplicate vertex $4$. Pivot from the old room $B_2$ to
