...
Unfortunately, this connection is less trivial than it first appears,
...
room partitions, as given in Figure \ref{oik-ex-fig}. Notice that only
...
\todo[inline]{from here: expand on savani}
...
labeled facets of a
polytope was given by von Stengel \cite{vs-noclf}. In the same article,
