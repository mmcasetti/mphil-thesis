...
finding a perfect matching or deciding that there isn't one takes polynomial
time for each $G_i$. Therefore, applying Algorithm (\ref{anothergale-alg})
...
\linebreak[5]
Suppose that Edmonds' algorithm returns the matching $M_0=\{ e_1,e_3 \}$ of
\linebreak[5]
