...
\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=80ex]{chapter-3/fig-lh/shapley-game-PQ-1.pdf}%
\hfill\strut
\caption[A game with disjoint Lemke paths]{%
Lemke paths for labels 1 (blue), 2 (green) and 3 (pink) on the best
response polytopes of game (\ref{disj-lp-game}). The paths for labels
