...
\begin{figure}[hp]
\strut\hfill
\includegraphics[width=40ex]{chapter-3/fig-lh/cube-pivot.pdf}%
\hfill\strut
...
\begin{figure}[hp]
\strut\hfill
\includegraphics[width=45ex]{chapter-3/fig-lh/octahedron-pivot.pdf}%
\hfill\strut
...
\begin{figure}[hp]
\strut\hfill
\includegraphics[width=38ex]{chapter-3/fig-lh/cube-pivot-label.pdf}%
\hfill\strut
...
\begin{figure}[hp]
\strut\hfill
\includegraphics[width=45ex]{chapter-3/fig-lh/octahedron-pivot-label.pdf}%
\hfill\strut
...
\todo[inline]{result can be extended to PPAD, see eg VvS for an in-depth study}
...
a solution to the {\bf PPAD} problem {\sc Another Completely Labeled Facet}.
...
\todo[inline]{done from here until end of section}
...
Morris's labeling is equilvalent to the following:
\[
\arraycolsep.2em
\begin{array}{rcll}
...
Savani and von Stengel \cite{svs} \cite{uvg} extended Morris's
