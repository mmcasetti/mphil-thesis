...
\begin{figure}[hp]
\strut\hfill
\includegraphics[width=50ex]{chapter-3/fig-lh/cube-1-pivot.pdf}%
\hfill\strut
...
\begin{figure}[hp]
\strut\hfill
\includegraphics[width=50ex]{chapter-3/fig-lh/octahedron-1-pivot.pdf}%
\hfill\strut
...
can be seen in the next example, due to Wilson, given in
Shapley \cite{shapley}. Notice that, by the parity result in
...
\begin{figure}[hbt]
\strut\hfill
\includegraphics[width=65ex]{chapter-3/fig-lh/shapley-game-sym.pdf}%
\hfill\strut
