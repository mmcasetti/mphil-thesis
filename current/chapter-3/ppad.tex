...
{\bf TFNP} is the class of all such problems for which at
least one such $y$ is guaranteed to exist for each~$x$.
Megiddo and Papadimitriou \cite{megiddo-papad} also proved that
% semantic class is a very hairy concept. You do not want to
% define this in a viva. Omit
