...
on the moment curve are affinely
\linebreak[4]
independent and define a
...
the exterior facet, in bold lines.
}
\label{c46-fig}
\end{figure}
\begin{figure}[hbt]
...
\todo[inline]{New counterexample, something like: 110101 (crossing in the middle)}
