...
\begin{proposition}
\label{aclv-ppa-thm}
{\sc Another Completely Labeled Vertex} is a problem in {\bf PPA}.
\end{proposition}
...
\begin{proposition}
\label{aclf-ppa-thm}
{\sc Another Completely Labeled Facet} is a problem in {\bf PPA}.
\end{proposition}
...
We will do so by giving an {\em index}
to the completely labeled Gale strings; we will then show that all the
endpoints of the Lemke paths have different index, so the Lemke paths can
be oriented from positive to negative index.

\todo[inline]{LHG oriented}
