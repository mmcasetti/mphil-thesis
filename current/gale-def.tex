...
a unit vector game $(U,B)$ where the best-response polytope $Q$ is
...
Then proposition \ref{ne-cl-pbl} becomes the following theorem.

\begin{theorem}\label{ne-another-gale-pbl}
The problem of finding a Nash equilibrium for a unit vector game is
