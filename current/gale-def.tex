...
vertices. Let $S=P\times Q$ be the best-response polytope for a
unit vector game $(U,B)$ as in theorem \ref{unit-vector-thm},
...
for each vertex $\mu(t_j)$, where $j\in [d + n]$.


\todo[inline]{
how labeled GS are corresponding to br cyclic polytopes

NB: we have given DUAL version (SvS 15) of Balthasar!!! vertices <-> facets
