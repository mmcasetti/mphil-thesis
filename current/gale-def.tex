...
We will now exploit the encoding of the facets of a cyclic polytope as
Gale strings given by theorem \ref{cp-gs-gale-thm} and the correspondence
between completely labeled facets of a dual cyclic polytope and Nash
equilibria of a game as seen in theorem \label{unit-vector-dual-thm}.
