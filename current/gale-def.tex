...
$1$'s in a bitstring is called a {\em run}. We denote a run of length
$k$ as $\1^k$; and, analogously, a string of 0's of length $k$ as $0^k$.
...
in dimension $d$, where $d$ is even, is polynomial-time reducible
