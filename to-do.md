...
* MAIN: matching GALE <--> PM
(Say this first, it's main idea!)
* this result led to further results, on which we report, about SIGN of PM (// index of NE) - started & proven for planar: JM; solved in general: VvS

START

Something less technical - basic definitions & problems

* NE
* polytope
* [use: section 2 SvS, quoted in VvS, section 2, pg 5]


GAME THEORY PART

* copy section 2 in ge (= published in ENDM) (co-author, can do copy-paste)
* improved version of thm 2.1 in ge, in Prop 1 in VvS (general, not just cyclic)
